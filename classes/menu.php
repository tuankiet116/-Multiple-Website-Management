...
class menu
{
	...
	*/
	...
	//gan du lieu vao mot array (diepcd)
	...
	//lay category cap cha cao nhat (diepcd)
	...
	*/
	function getComboxJava($table_name,$id_field,$name_field,$parent_id_field,$where_clause = "1"){
		...
		$i=-1;
		$cat_parent 	= -1;
		$return 		= '<script language="javascript"> /* diepcd@gmail.com  */ var listdb = new Array();';
		while($row=mysqli_fetch_assoc($db_getparent->result)){
			if($row[$parent_id_field]==0){
